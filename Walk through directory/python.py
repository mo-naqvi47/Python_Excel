...
for root, dirs, files in os.walk(mypath, topdown=False):
    for name in files:
        ...
        with pd.ExcelWriter(r"T:\WKFC\WKFC MASTER\Reports and Automation\AgRisk Rater Data Extraction\AgRisk_MissingAccounts.xlsx",mode='a',engine="openpyxl", if_sheet_exists='overlay') as writer:  
